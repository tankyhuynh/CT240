...
export class ChatComponent implements OnInit, AfterViewChecked {
  ...
  chatroom = {
    receive: {
      content: 'Để sử dụng được cái này, ta bắt buộc phải thêm display\: -webkit-box, thuộc tính -webkit-line-clamp sẽ quyết định số dòng tối đa được hiển thị. Tuy nhiên, cách làm này có 1 nhược điểm là không thể sử dụng padding, nó sẽ dẫn đến việc hiển thị 1 phần của dòng tiếp theo như này',
      time: 'Chương Quân 22:15'
    },
    send: {
      content: 'shadgf s fdasfdj gasjhdf sajh gfjas fjsa dfsa fjhsag jhfgsajfgjhas fdjhadfjhs jhfdasjhsadfjhsadjhf áh',
